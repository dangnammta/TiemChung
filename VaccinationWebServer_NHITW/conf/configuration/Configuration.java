...
public class Configuration {
    ...
    public static JSONObject generatorCapcha() {
        ...
        try {
            ...
            Random r = new Random();
            int index = Math.abs(r.nextInt(150));
...
//            OutputStream os = resp.getOutputStream();
            String subpathImg = "/captcha/captcha_" + System.nanoTime() + "_" + index + ".png";
            String path = configuration.Configuration.captcha_url + subpathImg;
            File outputfile = new File(path);
            ImageIO.write(bufferedImage, "png", outputfile);

            mapjson.put("path", configuration.Configuration.STATIC_URL + subpathImg);
