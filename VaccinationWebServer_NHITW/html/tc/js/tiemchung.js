...
var tc = {
    ...
    register: function() {
        var namechild = $("#val_namechild").val().trim();
        var birthday_child = $("#val_birthdaychild").val().trim();
        var val_name_parent = $("#val_name_parent").val().trim();
        var val_cmtnd_parent = $("#val_cmtnd_parent").val().trim();
        var val_phone_parent = $("#val_phone_parent").val().trim();
//        var val_email_parent = $("#val_email_parent").val();
        var val_captcha = $("#val_captcha").val();
        var val_vaccien = $("#val_vaccine").val().trim();
        var val_address = $("#val_address").val().trim();
