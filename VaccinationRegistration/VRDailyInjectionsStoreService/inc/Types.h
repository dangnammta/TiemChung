...
typedef TDailyInjections ValueT;
...
typedef CRDHN::VR::TVRDailyInjectionsStoreServiceIf ThriftIfaceT;
typedef CRDHN::VR::TVRDailyInjectionsStoreServiceProcessor ThriftProcessorT;
