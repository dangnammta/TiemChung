...
.build-conf: ${BUILD_SUBPROJECTS}
	"${MAKE}"  -f nbproject/Makefile-${CND_CONF}.mk bin/vrdailyinjectionsstoreserviced

bin/vrdailyinjectionsstoreserviced: ../corelibs/FUtility/lib/libfutility.a

bin/vrdailyinjectionsstoreserviced: ../corelibs/FThrift/lib/libfthrift.a

bin/vrdailyinjectionsstoreserviced: ../corelibs/FPoco/lib/libfpoco.a

bin/vrdailyinjectionsstoreserviced: ../corelibs/FEvent/lib/libfevent.a

bin/vrdailyinjectionsstoreserviced: ../corelibs/FZ/lib/libfz.a

bin/vrdailyinjectionsstoreserviced: ../corelibs/FOpenSSL/libs/libssl.a

bin/vrdailyinjectionsstoreserviced: ../corelibs/FOpenSSL/libs/libcrypto.a

bin/vrdailyinjectionsstoreserviced: ../corelibs/FKVDatabase/lib/libfkvdatabase.a

bin/vrdailyinjectionsstoreserviced: ${OBJECTFILES}
	${MKDIR} -p bin
	${LINK.cc} -o bin/vrdailyinjectionsstoreserviced ${OBJECTFILES} ${LDLIBSOPTIONS}
...
.clean-conf: ${CLEAN_SUBPROJECTS}
	...
	${RM} bin/vrdailyinjectionsstoreserviced
