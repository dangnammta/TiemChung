...
string Configuration::_StepCounterServiceVRRegistrationIdCntName = "CRDHN_VR_REGISTRATIONID";
...
const string Configuration::_configKeyStepCounterServiceVRRegistrationIdCntName = "crdhn.stepcounter.vr.registrationid.cntname";
...
void Configuration::initialize(Poco::Util::Application& application, FCore::Utility::ServiceConf::FConfKeeper* pCKServers) {
	...
	_StepCounterServiceVRRegistrationIdCntName = application.config().getString(_configKeyStepCounterServiceVRRegistrationIdCntName, _StepCounterServiceVRRegistrationIdCntName);
