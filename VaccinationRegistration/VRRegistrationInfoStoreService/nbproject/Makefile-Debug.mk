...
.build-conf: ${BUILD_SUBPROJECTS}
	"${MAKE}"  -f nbproject/Makefile-${CND_CONF}.mk bin/vrregistrationinfostoreserviced

bin/vrregistrationinfostoreserviced: ../corelibs/FUtility/lib/libfutility.a

bin/vrregistrationinfostoreserviced: ../corelibs/FThrift/lib/libfthrift.a

bin/vrregistrationinfostoreserviced: ../corelibs/FPoco/lib/libfpoco.a

bin/vrregistrationinfostoreserviced: ../corelibs/FEvent/lib/libfevent.a

bin/vrregistrationinfostoreserviced: ../corelibs/FZ/lib/libfz.a

bin/vrregistrationinfostoreserviced: ../corelibs/FOpenSSL/libs/libssl.a

bin/vrregistrationinfostoreserviced: ../corelibs/FOpenSSL/libs/libcrypto.a

bin/vrregistrationinfostoreserviced: ../corelibs/FKVDatabase/lib/libfkvdatabase.a

bin/vrregistrationinfostoreserviced: ${OBJECTFILES}
	${MKDIR} -p bin
	${LINK.cc} -o bin/vrregistrationinfostoreserviced ${OBJECTFILES} ${LDLIBSOPTIONS}
...
${OBJECTDIR}/thrift/gen-cpp/TVRRegistrationInfoStoreService.o: thrift/gen-cpp/TVRRegistrationInfoStoreService.cpp 
	${MKDIR} -p ${OBJECTDIR}/thrift/gen-cpp
	${RM} "$@.d"
	$(COMPILE.cc) -g -DHAVE_CONFIG_H -I../corelibs/FThrift/inc -I../corelibs/FPoco/inc -I../corelibs/FUtility/inc -I../corelibs/FUtility/thrift -Iinc -Ithrift/gen-cpp -I../corelibs/FBoost/inc -I../corelibs/FEvent/inc -I../corelibs/FOpenSSL/inc -I../corelibs/FZ/inc -I../corelibs/FKVDatabase/inc -I../corelibs/FKVDatabase/inc/kyotocabinet -I../corelibs/FKVDatabase/inc/leveldb -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/thrift/gen-cpp/TVRRegistrationInfoStoreService.o thrift/gen-cpp/TVRRegistrationInfoStoreService.cpp
...
${OBJECTDIR}/thrift/gen-cpp/vrregistrationinfostoreservice_constants.o: thrift/gen-cpp/vrregistrationinfostoreservice_constants.cpp 
	${MKDIR} -p ${OBJECTDIR}/thrift/gen-cpp
	${RM} "$@.d"
	$(COMPILE.cc) -g -DHAVE_CONFIG_H -I../corelibs/FThrift/inc -I../corelibs/FPoco/inc -I../corelibs/FUtility/inc -I../corelibs/FUtility/thrift -Iinc -Ithrift/gen-cpp -I../corelibs/FBoost/inc -I../corelibs/FEvent/inc -I../corelibs/FOpenSSL/inc -I../corelibs/FZ/inc -I../corelibs/FKVDatabase/inc -I../corelibs/FKVDatabase/inc/kyotocabinet -I../corelibs/FKVDatabase/inc/leveldb -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/thrift/gen-cpp/vrregistrationinfostoreservice_constants.o thrift/gen-cpp/vrregistrationinfostoreservice_constants.cpp

${OBJECTDIR}/thrift/gen-cpp/vrregistrationinfostoreservice_types.o: thrift/gen-cpp/vrregistrationinfostoreservice_types.cpp 
	${MKDIR} -p ${OBJECTDIR}/thrift/gen-cpp
	${RM} "$@.d"
	$(COMPILE.cc) -g -DHAVE_CONFIG_H -I../corelibs/FThrift/inc -I../corelibs/FPoco/inc -I../corelibs/FUtility/inc -I../corelibs/FUtility/thrift -Iinc -Ithrift/gen-cpp -I../corelibs/FBoost/inc -I../corelibs/FEvent/inc -I../corelibs/FOpenSSL/inc -I../corelibs/FZ/inc -I../corelibs/FKVDatabase/inc -I../corelibs/FKVDatabase/inc/kyotocabinet -I../corelibs/FKVDatabase/inc/leveldb -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/thrift/gen-cpp/vrregistrationinfostoreservice_types.o thrift/gen-cpp/vrregistrationinfostoreservice_types.cpp
...
.clean-conf: ${CLEAN_SUBPROJECTS}
	...
	${RM} bin/vrregistrationinfostoreserviced
