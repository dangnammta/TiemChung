...
.build-conf: ${BUILD_SUBPROJECTS}
	"${MAKE}"  -f nbproject/Makefile-${CND_CONF}.mk bin/vrdailyregistrationsstoreserviced

bin/vrdailyregistrationsstoreserviced: ../corelibs/FUtility/lib/libfutility.a

bin/vrdailyregistrationsstoreserviced: ../corelibs/FThrift/lib/libfthrift.a

bin/vrdailyregistrationsstoreserviced: ../corelibs/FPoco/lib/libfpoco.a

bin/vrdailyregistrationsstoreserviced: ../corelibs/FEvent/lib/libfevent.a

bin/vrdailyregistrationsstoreserviced: ../corelibs/FZ/lib/libfz.a

bin/vrdailyregistrationsstoreserviced: ../corelibs/FOpenSSL/libs/libssl.a

bin/vrdailyregistrationsstoreserviced: ../corelibs/FOpenSSL/libs/libcrypto.a

bin/vrdailyregistrationsstoreserviced: ../corelibs/FKVDatabase/lib/libfkvdatabase.a

bin/vrdailyregistrationsstoreserviced: ${OBJECTFILES}
	${MKDIR} -p bin
	${LINK.cc} -o bin/vrdailyregistrationsstoreserviced ${OBJECTFILES} ${LDLIBSOPTIONS}
...
${OBJECTDIR}/thrift/gen-cpp/TVRDailyRegistrationsStoreService.o: thrift/gen-cpp/TVRDailyRegistrationsStoreService.cpp 
	...
	${RM} "$@.d"
	$(COMPILE.cc) -g -DHAVE_CONFIG_H -I../corelibs/FThrift/inc -I../corelibs/FPoco/inc -I../corelibs/FUtility/inc -I../corelibs/FUtility/thrift -Iinc -Ithrift/gen-cpp -I../corelibs/FBoost/inc -I../corelibs/FEvent/inc -I../corelibs/FOpenSSL/inc -I../corelibs/FZ/inc -I../corelibs/FKVDatabase/inc -I../corelibs/FKVDatabase/inc/kyotocabinet -I../corelibs/FKVDatabase/inc/leveldb -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/thrift/gen-cpp/TVRDailyRegistrationsStoreService.o thrift/gen-cpp/TVRDailyRegistrationsStoreService.cpp
...
${OBJECTDIR}/thrift/gen-cpp/vrdailyregistrationsstoreservice_constants.o: thrift/gen-cpp/vrdailyregistrationsstoreservice_constants.cpp 
	${MKDIR} -p ${OBJECTDIR}/thrift/gen-cpp
	${RM} "$@.d"
	$(COMPILE.cc) -g -DHAVE_CONFIG_H -I../corelibs/FThrift/inc -I../corelibs/FPoco/inc -I../corelibs/FUtility/inc -I../corelibs/FUtility/thrift -Iinc -Ithrift/gen-cpp -I../corelibs/FBoost/inc -I../corelibs/FEvent/inc -I../corelibs/FOpenSSL/inc -I../corelibs/FZ/inc -I../corelibs/FKVDatabase/inc -I../corelibs/FKVDatabase/inc/kyotocabinet -I../corelibs/FKVDatabase/inc/leveldb -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/thrift/gen-cpp/vrdailyregistrationsstoreservice_constants.o thrift/gen-cpp/vrdailyregistrationsstoreservice_constants.cpp
...
${OBJECTDIR}/thrift/gen-cpp/vrdailyregistrationsstoreservice_types.o: thrift/gen-cpp/vrdailyregistrationsstoreservice_types.cpp 
	${MKDIR} -p ${OBJECTDIR}/thrift/gen-cpp
	${RM} "$@.d"
	$(COMPILE.cc) -g -DHAVE_CONFIG_H -I../corelibs/FThrift/inc -I../corelibs/FPoco/inc -I../corelibs/FUtility/inc -I../corelibs/FUtility/thrift -Iinc -Ithrift/gen-cpp -I../corelibs/FBoost/inc -I../corelibs/FEvent/inc -I../corelibs/FOpenSSL/inc -I../corelibs/FZ/inc -I../corelibs/FKVDatabase/inc -I../corelibs/FKVDatabase/inc/kyotocabinet -I../corelibs/FKVDatabase/inc/leveldb -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/thrift/gen-cpp/vrdailyregistrationsstoreservice_types.o thrift/gen-cpp/vrdailyregistrationsstoreservice_types.cpp
...
.clean-conf: ${CLEAN_SUBPROJECTS}
	...
	${RM} bin/vrdailyregistrationsstoreserviced
