...
.build-conf: ${BUILD_SUBPROJECTS}
	"${MAKE}"  -f nbproject/Makefile-${CND_CONF}.mk bin/vrcentreinfostoreserviced

bin/vrcentreinfostoreserviced: ../corelibs/FUtility/lib/libfutility.a

bin/vrcentreinfostoreserviced: ../corelibs/FThrift/lib/libfthrift.a

bin/vrcentreinfostoreserviced: ../corelibs/FPoco/lib/libfpoco.a

bin/vrcentreinfostoreserviced: ../corelibs/FEvent/lib/libfevent.a

bin/vrcentreinfostoreserviced: ../corelibs/FZ/lib/libfz.a

bin/vrcentreinfostoreserviced: ../corelibs/FOpenSSL/libs/libssl.a

bin/vrcentreinfostoreserviced: ../corelibs/FOpenSSL/libs/libcrypto.a

bin/vrcentreinfostoreserviced: ../corelibs/FKVDatabase/lib/libfkvdatabase.a

bin/vrcentreinfostoreserviced: ${OBJECTFILES}
	${MKDIR} -p bin
	${LINK.cc} -o bin/vrcentreinfostoreserviced ${OBJECTFILES} ${LDLIBSOPTIONS}
...
${OBJECTDIR}/thrift/gen-cpp/TVRCentreInfoStoreService.o: thrift/gen-cpp/TVRCentreInfoStoreService.cpp 
	${MKDIR} -p ${OBJECTDIR}/thrift/gen-cpp
	${RM} "$@.d"
	$(COMPILE.cc) -g -DHAVE_CONFIG_H -I../corelibs/FThrift/inc -I../corelibs/FPoco/inc -I../corelibs/FUtility/inc -I../corelibs/FUtility/thrift -Iinc -Ithrift/gen-cpp -I../corelibs/FBoost/inc -I../corelibs/FEvent/inc -I../corelibs/FOpenSSL/inc -I../corelibs/FZ/inc -I../corelibs/FKVDatabase/inc -I../corelibs/FKVDatabase/inc/kyotocabinet -I../corelibs/FKVDatabase/inc/leveldb -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/thrift/gen-cpp/TVRCentreInfoStoreService.o thrift/gen-cpp/TVRCentreInfoStoreService.cpp
...
${OBJECTDIR}/thrift/gen-cpp/vrcentreinfostoreservice_constants.o: thrift/gen-cpp/vrcentreinfostoreservice_constants.cpp 
	${MKDIR} -p ${OBJECTDIR}/thrift/gen-cpp
	${RM} "$@.d"
	$(COMPILE.cc) -g -DHAVE_CONFIG_H -I../corelibs/FThrift/inc -I../corelibs/FPoco/inc -I../corelibs/FUtility/inc -I../corelibs/FUtility/thrift -Iinc -Ithrift/gen-cpp -I../corelibs/FBoost/inc -I../corelibs/FEvent/inc -I../corelibs/FOpenSSL/inc -I../corelibs/FZ/inc -I../corelibs/FKVDatabase/inc -I../corelibs/FKVDatabase/inc/kyotocabinet -I../corelibs/FKVDatabase/inc/leveldb -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/thrift/gen-cpp/vrcentreinfostoreservice_constants.o thrift/gen-cpp/vrcentreinfostoreservice_constants.cpp

${OBJECTDIR}/thrift/gen-cpp/vrcentreinfostoreservice_types.o: thrift/gen-cpp/vrcentreinfostoreservice_types.cpp 
	${MKDIR} -p ${OBJECTDIR}/thrift/gen-cpp
	${RM} "$@.d"
	$(COMPILE.cc) -g -DHAVE_CONFIG_H -I../corelibs/FThrift/inc -I../corelibs/FPoco/inc -I../corelibs/FUtility/inc -I../corelibs/FUtility/thrift -Iinc -Ithrift/gen-cpp -I../corelibs/FBoost/inc -I../corelibs/FEvent/inc -I../corelibs/FOpenSSL/inc -I../corelibs/FZ/inc -I../corelibs/FKVDatabase/inc -I../corelibs/FKVDatabase/inc/kyotocabinet -I../corelibs/FKVDatabase/inc/leveldb -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/thrift/gen-cpp/vrcentreinfostoreservice_types.o thrift/gen-cpp/vrcentreinfostoreservice_types.cpp
...
.clean-conf: ${CLEAN_SUBPROJECTS}
	...
	${RM} bin/vrcentreinfostoreserviced
