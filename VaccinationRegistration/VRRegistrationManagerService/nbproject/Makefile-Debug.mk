...
.build-conf: ${BUILD_SUBPROJECTS}
	"${MAKE}"  -f nbproject/Makefile-${CND_CONF}.mk bin/vrregistrationmanagerserviced

bin/vrregistrationmanagerserviced: ../corelibs/FUtility/lib/libfutility.a

bin/vrregistrationmanagerserviced: ../corelibs/FThrift/lib/libfthrift.a

bin/vrregistrationmanagerserviced: ../corelibs/FMongoDB/lib/libfmongodb.a

bin/vrregistrationmanagerserviced: ../corelibs/FPoco/lib/libfpoco.a

bin/vrregistrationmanagerserviced: ../corelibs/FEvent/lib/libfevent.a

bin/vrregistrationmanagerserviced: ../corelibs/FZ/lib/libfz.a

bin/vrregistrationmanagerserviced: ../corelibs/FOpenSSL/libs/libssl.a

bin/vrregistrationmanagerserviced: ../corelibs/FOpenSSL/libs/libcrypto.a

bin/vrregistrationmanagerserviced: ${OBJECTFILES}
	${MKDIR} -p bin
	${LINK.cc} -o bin/vrregistrationmanagerserviced ${OBJECTFILES} ${LDLIBSOPTIONS}
...
.clean-conf: ${CLEAN_SUBPROJECTS}
	...
	${RM} bin/vrregistrationmanagerserviced
