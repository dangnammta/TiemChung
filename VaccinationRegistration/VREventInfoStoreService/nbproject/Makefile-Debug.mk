...
.build-conf: ${BUILD_SUBPROJECTS}
	"${MAKE}"  -f nbproject/Makefile-${CND_CONF}.mk bin/vreventinfostoreserviced

bin/vreventinfostoreserviced: ../corelibs/FUtility/lib/libfutility.a

bin/vreventinfostoreserviced: ../corelibs/FThrift/lib/libfthrift.a

bin/vreventinfostoreserviced: ../corelibs/FPoco/lib/libfpoco.a

bin/vreventinfostoreserviced: ../corelibs/FEvent/lib/libfevent.a

bin/vreventinfostoreserviced: ../corelibs/FZ/lib/libfz.a

bin/vreventinfostoreserviced: ../corelibs/FOpenSSL/libs/libssl.a

bin/vreventinfostoreserviced: ../corelibs/FOpenSSL/libs/libcrypto.a

bin/vreventinfostoreserviced: ../corelibs/FKVDatabase/lib/libfkvdatabase.a

bin/vreventinfostoreserviced: ${OBJECTFILES}
	${MKDIR} -p bin
	${LINK.cc} -o bin/vreventinfostoreserviced ${OBJECTFILES} ${LDLIBSOPTIONS}
...
${OBJECTDIR}/thrift/gen-cpp/TVREventInfoStoreService.o: thrift/gen-cpp/TVREventInfoStoreService.cpp 
	${MKDIR} -p ${OBJECTDIR}/thrift/gen-cpp
	${RM} "$@.d"
	$(COMPILE.cc) -g -DHAVE_CONFIG_H -I../corelibs/FThrift/inc -I../corelibs/FPoco/inc -I../corelibs/FUtility/inc -I../corelibs/FUtility/thrift -Iinc -Ithrift/gen-cpp -I../corelibs/FBoost/inc -I../corelibs/FEvent/inc -I../corelibs/FOpenSSL/inc -I../corelibs/FZ/inc -I../corelibs/FKVDatabase/inc -I../corelibs/FKVDatabase/inc/kyotocabinet -I../corelibs/FKVDatabase/inc/leveldb -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/thrift/gen-cpp/TVREventInfoStoreService.o thrift/gen-cpp/TVREventInfoStoreService.cpp
...
${OBJECTDIR}/thrift/gen-cpp/vreventinfostoreservice_constants.o: thrift/gen-cpp/vreventinfostoreservice_constants.cpp 
	${MKDIR} -p ${OBJECTDIR}/thrift/gen-cpp
	${RM} "$@.d"
	$(COMPILE.cc) -g -DHAVE_CONFIG_H -I../corelibs/FThrift/inc -I../corelibs/FPoco/inc -I../corelibs/FUtility/inc -I../corelibs/FUtility/thrift -Iinc -Ithrift/gen-cpp -I../corelibs/FBoost/inc -I../corelibs/FEvent/inc -I../corelibs/FOpenSSL/inc -I../corelibs/FZ/inc -I../corelibs/FKVDatabase/inc -I../corelibs/FKVDatabase/inc/kyotocabinet -I../corelibs/FKVDatabase/inc/leveldb -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/thrift/gen-cpp/vreventinfostoreservice_constants.o thrift/gen-cpp/vreventinfostoreservice_constants.cpp

${OBJECTDIR}/thrift/gen-cpp/vreventinfostoreservice_types.o: thrift/gen-cpp/vreventinfostoreservice_types.cpp 
	${MKDIR} -p ${OBJECTDIR}/thrift/gen-cpp
	${RM} "$@.d"
	$(COMPILE.cc) -g -DHAVE_CONFIG_H -I../corelibs/FThrift/inc -I../corelibs/FPoco/inc -I../corelibs/FUtility/inc -I../corelibs/FUtility/thrift -Iinc -Ithrift/gen-cpp -I../corelibs/FBoost/inc -I../corelibs/FEvent/inc -I../corelibs/FOpenSSL/inc -I../corelibs/FZ/inc -I../corelibs/FKVDatabase/inc -I../corelibs/FKVDatabase/inc/kyotocabinet -I../corelibs/FKVDatabase/inc/leveldb -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/thrift/gen-cpp/vreventinfostoreservice_types.o thrift/gen-cpp/vreventinfostoreservice_types.cpp
...
.clean-conf: ${CLEAN_SUBPROJECTS}
	...
	${RM} bin/vreventinfostoreserviced
