...
public class TVRRegistrationManagerService {
  ...
  public interface Iface {
    ...
    public crdhn.vr.thrift.response.TRMAddRegistrationResponse addExtendedRegistration(crdhn.vr.thrift.data.TRegistrationInfo registrationInfo, int desiredOrderNumber) throws org.apache.thrift.TException;
  ...
  public interface AsyncIface {
    ...
    public void addExtendedRegistration(crdhn.vr.thrift.data.TRegistrationInfo registrationInfo, int desiredOrderNumber, org.apache.thrift.async.AsyncMethodCallback resultHandler) throws org.apache.thrift.TException;
  ...
  public static class Client extends org.apache.thrift.TServiceClient implements Iface {
    ...
    public void send_addExtendedRegistration(crdhn.vr.thrift.data.TRegistrationInfo registrationInfo, int desiredOrderNumber) throws org.apache.thrift.TException
    {
      addExtendedRegistration_args args = new addExtendedRegistration_args();
      args.setRegistrationInfo(registrationInfo);
      args.setDesiredOrderNumber(desiredOrderNumber);
  ...
  public static class AsyncClient extends org.apache.thrift.async.TAsyncClient implements AsyncIface {
    ...
    public void addExtendedRegistration(crdhn.vr.thrift.data.TRegistrationInfo registrationInfo, int desiredOrderNumber, org.apache.thrift.async.AsyncMethodCallback resultHandler) throws org.apache.thrift.TException {
      checkReady();
      addExtendedRegistration_call method_call = new addExtendedRegistration_call(registrationInfo, desiredOrderNumber, resultHandler, this, ___protocolFactory, ___transport);
      this.___currentMethod = method_call;
      ___manager.call(method_call);
    }
    ...
    public static class addExtendedRegistration_call extends org.apache.thrift.async.TAsyncMethodCall {
      private crdhn.vr.thrift.data.TRegistrationInfo registrationInfo;
      private int desiredOrderNumber;
      public addExtendedRegistration_call(crdhn.vr.thrift.data.TRegistrationInfo registrationInfo, int desiredOrderNumber, org.apache.thrift.async.AsyncMethodCallback resultHandler, org.apache.thrift.async.TAsyncClient client, org.apache.thrift.protocol.TProtocolFactory protocolFactory, org.apache.thrift.transport.TNonblockingTransport transport) throws org.apache.thrift.TException {
        super(client, protocolFactory, transport, resultHandler, false);
        this.registrationInfo = registrationInfo;
        this.desiredOrderNumber = desiredOrderNumber;
      }
  ...
  public static class Processor<I extends Iface> extends org.apache.thrift.TBaseProcessor<I> implements org.apache.thrift.TProcessor {
    ...
    public static class addExtendedRegistration<I extends Iface> extends org.apache.thrift.ProcessFunction<I, addExtendedRegistration_args> {
      ...
      public addExtendedRegistration_result getResult(I iface, addExtendedRegistration_args args) throws org.apache.thrift.TException {
        addExtendedRegistration_result result = new addExtendedRegistration_result();
        result.success = iface.addExtendedRegistration(args.registrationInfo, args.desiredOrderNumber);
        return result;
      }
    }
  ...
  public static class AsyncProcessor<I extends AsyncIface> extends org.apache.thrift.TBaseAsyncProcessor<I> {
    ...
    public static class addExtendedRegistration<I extends AsyncIface> extends org.apache.thrift.AsyncProcessFunction<I, addExtendedRegistration_args, crdhn.vr.thrift.response.TRMAddRegistrationResponse> {
      ...
      public void start(I iface, addExtendedRegistration_args args, org.apache.thrift.async.AsyncMethodCallback<crdhn.vr.thrift.response.TRMAddRegistrationResponse> resultHandler) throws TException {
        iface.addExtendedRegistration(args.registrationInfo, args.desiredOrderNumber,resultHandler);
      }
    }
  ...
  public static class addExtendedRegistration_args implements org.apache.thrift.TBase<addExtendedRegistration_args, addExtendedRegistration_args._Fields>, java.io.Serializable, Cloneable, Comparable<addExtendedRegistration_args>   {
    ...
    private static final org.apache.thrift.protocol.TField REGISTRATION_INFO_FIELD_DESC = new org.apache.thrift.protocol.TField("registrationInfo", org.apache.thrift.protocol.TType.STRUCT, (short)1);
    private static final org.apache.thrift.protocol.TField DESIRED_ORDER_NUMBER_FIELD_DESC = new org.apache.thrift.protocol.TField("desiredOrderNumber", org.apache.thrift.protocol.TType.I32, (short)2);
    ...
    public crdhn.vr.thrift.data.TRegistrationInfo registrationInfo; // required
    public int desiredOrderNumber; // required

    /** The set of fields this struct contains, along with convenience methods for finding and manipulating them. */
    public enum _Fields implements org.apache.thrift.TFieldIdEnum {
      REGISTRATION_INFO((short)1, "registrationInfo"),
      DESIRED_ORDER_NUMBER((short)2, "desiredOrderNumber");
      ...
      public static _Fields findByThriftId(int fieldId) {
        switch(fieldId) {
          case 1: // REGISTRATION_INFO
            return REGISTRATION_INFO;
          case 2: // DESIRED_ORDER_NUMBER
            return DESIRED_ORDER_NUMBER;
          default:
            return null;
        }
      }
    ...
    // isset id assignments
    private static final int __DESIREDORDERNUMBER_ISSET_ID = 0;
    private byte __isset_bitfield = 0;
    public static final Map<_Fields, org.apache.thrift.meta_data.FieldMetaData> metaDataMap;
    static {
      Map<_Fields, org.apache.thrift.meta_data.FieldMetaData> tmpMap = new EnumMap<_Fields, org.apache.thrift.meta_data.FieldMetaData>(_Fields.class);
      tmpMap.put(_Fields.REGISTRATION_INFO, new org.apache.thrift.meta_data.FieldMetaData("registrationInfo", org.apache.thrift.TFieldRequirementType.DEFAULT, 
          new org.apache.thrift.meta_data.StructMetaData(org.apache.thrift.protocol.TType.STRUCT, crdhn.vr.thrift.data.TRegistrationInfo.class)));
      tmpMap.put(_Fields.DESIRED_ORDER_NUMBER, new org.apache.thrift.meta_data.FieldMetaData("desiredOrderNumber", org.apache.thrift.TFieldRequirementType.DEFAULT, 
    ...
    public addExtendedRegistration_args(
      crdhn.vr.thrift.data.TRegistrationInfo registrationInfo,
      int desiredOrderNumber)
    {
      this();
      this.registrationInfo = registrationInfo;
      this.desiredOrderNumber = desiredOrderNumber;
      setDesiredOrderNumberIsSet(true);
    }
    ...
    public addExtendedRegistration_args(addExtendedRegistration_args other) {
      ...
      this.desiredOrderNumber = other.desiredOrderNumber;
    }
    ...
    public void clear() {
      this.registrationInfo = null;
      setDesiredOrderNumberIsSet(false);
      this.desiredOrderNumber = 0;
    }
    ...
    public int getDesiredOrderNumber() {
      return this.desiredOrderNumber;
    }

    public addExtendedRegistration_args setDesiredOrderNumber(int desiredOrderNumber) {
      this.desiredOrderNumber = desiredOrderNumber;
      setDesiredOrderNumberIsSet(true);
      return this;
    }

    public void unsetDesiredOrderNumber() {
      __isset_bitfield = EncodingUtils.clearBit(__isset_bitfield, __DESIREDORDERNUMBER_ISSET_ID);
    }

    /** Returns true if field desiredOrderNumber is set (has been assigned a value) and false otherwise */
    public boolean isSetDesiredOrderNumber() {
      return EncodingUtils.testBit(__isset_bitfield, __DESIREDORDERNUMBER_ISSET_ID);
    }

    public void setDesiredOrderNumberIsSet(boolean value) {
      __isset_bitfield = EncodingUtils.setBit(__isset_bitfield, __DESIREDORDERNUMBER_ISSET_ID, value);
    }
    ...
    public void setFieldValue(_Fields field, Object value) {
      ...
      case DESIRED_ORDER_NUMBER:
        if (value == null) {
          unsetDesiredOrderNumber();
        } else {
          setDesiredOrderNumber((Integer)value);
        }
        break;
    ...
    public Object getFieldValue(_Fields field) {
      ...
      case DESIRED_ORDER_NUMBER:
        return Integer.valueOf(getDesiredOrderNumber());
    ...
    public boolean isSet(_Fields field) {
      ...
      case REGISTRATION_INFO:
        return isSetRegistrationInfo();
      case DESIRED_ORDER_NUMBER:
        return isSetDesiredOrderNumber();
      }
      throw new IllegalStateException();
    }
    ...
    public boolean equals(addExtendedRegistration_args that) {
      ...
      boolean this_present_desiredOrderNumber = true;
      boolean that_present_desiredOrderNumber = true;
      if (this_present_desiredOrderNumber || that_present_desiredOrderNumber) {
        if (!(this_present_desiredOrderNumber && that_present_desiredOrderNumber))
          return false;
        if (this.desiredOrderNumber != that.desiredOrderNumber)
          return false;
      }
    ...
    public int compareTo(addExtendedRegistration_args other) {
      ...
      lastComparison = Boolean.valueOf(isSetDesiredOrderNumber()).compareTo(other.isSetDesiredOrderNumber());
      if (lastComparison != 0) {
        return lastComparison;
      }
      if (isSetDesiredOrderNumber()) {
        lastComparison = org.apache.thrift.TBaseHelper.compareTo(this.desiredOrderNumber, other.desiredOrderNumber);
        if (lastComparison != 0) {
          return lastComparison;
        }
      }
    ...
    public String toString() {
      ...
      first = false;
      if (!first) sb.append(", ");
      sb.append("desiredOrderNumber:");
      sb.append(this.desiredOrderNumber);
      first = false;
      sb.append(")");
      return sb.toString();
    }
    ...
    private static class addExtendedRegistration_argsStandardScheme extends StandardScheme<addExtendedRegistration_args> {
      ...
      public void read(org.apache.thrift.protocol.TProtocol iprot, addExtendedRegistration_args struct) throws org.apache.thrift.TException {
        ...
        while (true)
        {
          ...
          switch (schemeField.id) {
            ...
            case 2: // DESIRED_ORDER_NUMBER
              if (schemeField.type == org.apache.thrift.protocol.TType.I32) {
                struct.desiredOrderNumber = iprot.readI32();
                struct.setDesiredOrderNumberIsSet(true);
              } else { 
                org.apache.thrift.protocol.TProtocolUtil.skip(iprot, schemeField.type);
              }
              break;
      ...
      public void write(org.apache.thrift.protocol.TProtocol oprot, addExtendedRegistration_args struct) throws org.apache.thrift.TException {
        ...
        oprot.writeFieldBegin(DESIRED_ORDER_NUMBER_FIELD_DESC);
        oprot.writeI32(struct.desiredOrderNumber);
        oprot.writeFieldEnd();
        oprot.writeFieldStop();
        oprot.writeStructEnd();
      }
    ...
    private static class addExtendedRegistration_argsTupleScheme extends TupleScheme<addExtendedRegistration_args> {
      ...
      public void write(org.apache.thrift.protocol.TProtocol prot, addExtendedRegistration_args struct) throws org.apache.thrift.TException {
        ...
        if (struct.isSetDesiredOrderNumber()) {
          optionals.set(1);
        }
