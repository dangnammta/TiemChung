...
.build-conf: ${BUILD_SUBPROJECTS}
	"${MAKE}"  -f nbproject/Makefile-${CND_CONF}.mk bin/vrallclient

bin/vrallclient: ../corelibs/FUtility/lib/libfutility.a

bin/vrallclient: ../corelibs/FThrift/lib/libfthrift.a

bin/vrallclient: ../corelibs/FMongoDB/lib/libfmongodb.a

bin/vrallclient: ../corelibs/FPoco/lib/libfpoco.a

bin/vrallclient: ../corelibs/FEvent/lib/libfevent.a

bin/vrallclient: ../corelibs/FZ/lib/libfz.a

bin/vrallclient: ../corelibs/FOpenSSL/libs/libssl.a

bin/vrallclient: ../corelibs/FOpenSSL/libs/libcrypto.a

bin/vrallclient: ${OBJECTFILES}
	${MKDIR} -p bin
	${LINK.cc} -o bin/vrallclient ${OBJECTFILES} ${LDLIBSOPTIONS}

${OBJECTDIR}/main.o: main.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -DHAVE_CONFIG_H -I../corelibs/FThrift/inc -I../corelibs/FPoco/inc -I../corelibs/FUtility/inc -I../corelibs/FUtility/thrift -Iinc -Ithrift/gen-cpp -I../corelibs/FBoost/inc -I../corelibs/FEvent/inc -I../corelibs/FOpenSSL/inc -I../corelibs/FZ/inc -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/main.o main.cpp
...
${OBJECTDIR}/thrift/gen-cpp/TVRVaccinationCentreInfoStoreService.o: thrift/gen-cpp/TVRVaccinationCentreInfoStoreService.cpp 
	${MKDIR} -p ${OBJECTDIR}/thrift/gen-cpp
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -DHAVE_CONFIG_H -I../corelibs/FThrift/inc -I../corelibs/FPoco/inc -I../corelibs/FUtility/inc -I../corelibs/FUtility/thrift -Iinc -Ithrift/gen-cpp -I../corelibs/FBoost/inc -I../corelibs/FEvent/inc -I../corelibs/FOpenSSL/inc -I../corelibs/FZ/inc -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/thrift/gen-cpp/TVRVaccinationCentreInfoStoreService.o thrift/gen-cpp/TVRVaccinationCentreInfoStoreService.cpp

${OBJECTDIR}/thrift/gen-cpp/TVRVaccinationManagerService.o: thrift/gen-cpp/TVRVaccinationManagerService.cpp 
	${MKDIR} -p ${OBJECTDIR}/thrift/gen-cpp
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -DHAVE_CONFIG_H -I../corelibs/FThrift/inc -I../corelibs/FPoco/inc -I../corelibs/FUtility/inc -I../corelibs/FUtility/thrift -Iinc -Ithrift/gen-cpp -I../corelibs/FBoost/inc -I../corelibs/FEvent/inc -I../corelibs/FOpenSSL/inc -I../corelibs/FZ/inc -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/thrift/gen-cpp/TVRVaccinationManagerService.o thrift/gen-cpp/TVRVaccinationManagerService.cpp
...
${OBJECTDIR}/thrift/gen-cpp/vrvaccinationcentreinfostoreservice_constants.o: thrift/gen-cpp/vrvaccinationcentreinfostoreservice_constants.cpp 
	${MKDIR} -p ${OBJECTDIR}/thrift/gen-cpp
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -DHAVE_CONFIG_H -I../corelibs/FThrift/inc -I../corelibs/FPoco/inc -I../corelibs/FUtility/inc -I../corelibs/FUtility/thrift -Iinc -Ithrift/gen-cpp -I../corelibs/FBoost/inc -I../corelibs/FEvent/inc -I../corelibs/FOpenSSL/inc -I../corelibs/FZ/inc -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/thrift/gen-cpp/vrvaccinationcentreinfostoreservice_constants.o thrift/gen-cpp/vrvaccinationcentreinfostoreservice_constants.cpp
...
${OBJECTDIR}/thrift/gen-cpp/vrvaccinationcentreinfostoreservice_types.o: thrift/gen-cpp/vrvaccinationcentreinfostoreservice_types.cpp 
	${MKDIR} -p ${OBJECTDIR}/thrift/gen-cpp
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -DHAVE_CONFIG_H -I../corelibs/FThrift/inc -I../corelibs/FPoco/inc -I../corelibs/FUtility/inc -I../corelibs/FUtility/thrift -Iinc -Ithrift/gen-cpp -I../corelibs/FBoost/inc -I../corelibs/FEvent/inc -I../corelibs/FOpenSSL/inc -I../corelibs/FZ/inc -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/thrift/gen-cpp/vrvaccinationcentreinfostoreservice_types.o thrift/gen-cpp/vrvaccinationcentreinfostoreservice_types.cpp
...
${OBJECTDIR}/thrift/gen-cpp/vrvaccinationmanagerservice_constants.o: thrift/gen-cpp/vrvaccinationmanagerservice_constants.cpp 
	${MKDIR} -p ${OBJECTDIR}/thrift/gen-cpp
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -DHAVE_CONFIG_H -I../corelibs/FThrift/inc -I../corelibs/FPoco/inc -I../corelibs/FUtility/inc -I../corelibs/FUtility/thrift -Iinc -Ithrift/gen-cpp -I../corelibs/FBoost/inc -I../corelibs/FEvent/inc -I../corelibs/FOpenSSL/inc -I../corelibs/FZ/inc -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/thrift/gen-cpp/vrvaccinationmanagerservice_constants.o thrift/gen-cpp/vrvaccinationmanagerservice_constants.cpp

${OBJECTDIR}/thrift/gen-cpp/vrvaccinationmanagerservice_types.o: thrift/gen-cpp/vrvaccinationmanagerservice_types.cpp 
	${MKDIR} -p ${OBJECTDIR}/thrift/gen-cpp
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -DHAVE_CONFIG_H -I../corelibs/FThrift/inc -I../corelibs/FPoco/inc -I../corelibs/FUtility/inc -I../corelibs/FUtility/thrift -Iinc -Ithrift/gen-cpp -I../corelibs/FBoost/inc -I../corelibs/FEvent/inc -I../corelibs/FOpenSSL/inc -I../corelibs/FZ/inc -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/thrift/gen-cpp/vrvaccinationmanagerservice_types.o thrift/gen-cpp/vrvaccinationmanagerservice_types.cpp
